    ...
    for person_bbox in persons:
        for vehicle_bbox in bicycles + motorcycles:
            if (
                ...
                # Draw a green box if person is overlapping with bicycle or motorcycle
                cv2.rectangle(frame, (person_bbox[0], person_bbox[1]), (person_bbox[2], person_bbox[3]), (0, 255, 0), 2)
